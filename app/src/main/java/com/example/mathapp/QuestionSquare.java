...
public class QuestionSquare {
    ...
    public QuestionSquare (int upperLimit){
        this.upperLimit=upperLimit;
        Random randomNumber=new Random();
        this.fistNumber=randomNumber.nextInt(100-1)+1;
        this.answer= (int) Math.sqrt(this.fistNumber);

        this.questionPharse= "√¯"+fistNumber+"=";
