...
public class MultipActivity extends AppCompatActivity {
    ...
    GameMultip g=new GameMultip();
    int secondRemaining = 60; //kalan saniyeyi tutacak değişken



    //gerisayınsayacı oluşturuyoruz
    ...
    private void nextTurn(){
        ...
        g.makeNewQuestion();
        int  [] answer= g.getCurrentQuestions().getAnswerMultipArray();
        ...
        tv_question.setText(g.getCurrentQuestions().getQuestionPharse());
